...
class c_particle_billboard_draw : private calculate
{
public:
	void initialize();
...
private:
	...
	GLuint m_uniform_CameraRight_worldspace = 0;
	GLuint m_uniform_CameraUp_worldspace = 0;
	GLuint m_uniform_ViewProjMatrix = 0;
	GLuint m_uniform_TextureSampler = 0;
